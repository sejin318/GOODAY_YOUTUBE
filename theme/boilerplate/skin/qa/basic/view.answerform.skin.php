...
<section id="bo_v_ans_form">
    ...
    {
    ?>
        <h2 class="page-title p-2 mt-3 mb-3">답변등록</h2>
        ...
        <form name="fanswer" method="post" action="./qawrite_update.php" onsubmit="return fwrite_submit(this);" autocomplete="off">
            ...
            <div class="form-write">
                ...
                <div class='form-group'>
                    ...
                    <input type="text" name="qa_subject" value="" id="qa_subject" required class="required form-control" size="50" maxlength="255" placeholder="제목">
                </div>
