...
<section id="bo_w">
    <h2 class="page-title p-2 mb-2">1:1문의 작성</h2>
    <!-- 게시물 작성/수정 시작 { -->
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="form-write">
            <?php if ($category_option) { ?>
                <div class="form-group bo_w_select write_div">
            ...
            <?php if ($is_email) { ?>
                <div class="form-group bo_w_mail chk_box">
            ...
            <div class="form-group bo_w_flie">
                <div class="file_wr">
        ...
        <div class="btn-navbar text-right mb-5">
