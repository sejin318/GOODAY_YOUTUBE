        ...
        <form name="foutlogin" action="<?php echo $outlogin_action_url ?>" onsubmit="return fhead_submit(this);" method="post" autocomplete="off">
            ...
            <div class="form-group form-subject">
                <div class="input-group">
                    ...
                    <input type="text" id="ol_id" class='form-control' name="mb_id" required maxlength="20" placeholder="아이디">
                </div>
                <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    <input type="password" name="mb_password" id="ol_pw" class='form-control' required maxlength="20" placeholder="비밀번호">
                </div>
            </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text">
                            <input type="checkbox" name="auto_login" value="1" id="auto_login" class="fomr-check-input">
                            <label class="form-check-label" for="auto_login"> Auto</label>
                        </span>
                    </div>
                    <input type="submit" id="ol_submit" value="로그인" class="form-control btn btn-info">
                </div>
            </div>
