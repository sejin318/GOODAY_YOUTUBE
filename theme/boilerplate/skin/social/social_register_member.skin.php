...
<div class="sns-login-wrap">
    ...
    <div class="mbskin" id="register_member">
        ...
        <form id="fregisterform" name="fregisterform" action="<?php echo $register_action_url; ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="toggle">
                <div class="toggle-title">
                    <span class="right_i btn btn-outline-secondary btn-sm"> 자세히보기</span>
            ...
            <div class="sns_tbl tbl_wrap">
                <div class="input-group">
                    ...
                    <input type="text" name="mb_email" value="<?php echo isset($user_email) ? $user_email : ''; ?>" id="reg_mb_email" required class="form-control required" size="70" maxlength="100" placeholder="이메일을 입력해주세요.">
                </div>
                <p class="email_msg"><?php echo $email_msg; ?></p>

            </div>

            <div class="form-action d-flex justify-content-center mt-5">
                <input type="submit" value="회원가입" id="btn_submit" class="btn btn-primary btn-lg mr-1" accesskey="s">
                <a href="<?php echo G5_URL ?>" class="btn btn-danger btn-lg">취소</a>
            </div>
        </form>
        <!-- 새로가입 끝 -->
        ...
        <div class="member-wrap jumbotron jumbotron-sm">
            <div class="alert alert-warning">
                <i class="fa fa-question-circle" aria-hidden="true"></i>
                혹시 기존 회원이신가요?
            </div>
            <button type="button" class="connect-opener btn-primary btn" data-remodal-target="modal">
                기존 계정에 연결하기
        ...
        <div id="sns-link-pnl" class="remodal" data-remodal-id="modal" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
            ...
            <div class="connect-fg">
                <form method="post" action="<?php echo $login_action_url ?>" onsubmit="return social_obj.flogin_submit(this);">
                    ...
                    <h3 class="connect-title">기존 계정에 연결하기</h3>
                    ...
                    <div id="login_fs">
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="mb_id" id="login_id" class="form-control required" size="20" maxLength="20">
                        </div>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text">비밀번호</span>
                            </div>
                            <input type="password" name="mb_password" id="login_pw" class="form-control required" size="20" maxLength="20">
                        </div>


                        <div class="form-action mt-1">
                            <input type="submit" value="연결하기" class="login_submit btn btn-primary mr-1">
                            <button type="button" class="btn btn-danger connect-close" data-remodal-action="close">
