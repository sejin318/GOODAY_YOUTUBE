...
add_stylesheet('<link rel="stylesheet" href="' . G5_PLUGIN_URL . '/ask-uploader/css/askuploader.css">', 0);
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            <p>
                ...
                <?php
                    if (AU_COMMENT == true) {
                        /**
                         * ASKUPLOAD
                         * 댓글 HTML처리를 위해 BBCode 사용.
                         */
                        //$bbcode = new BBCode;
                        //echo $bbcode->toHTML($str);
                        echo bbcode_image_tag($str);
                    }else{
                        echo $str;
                    }
                ?>
            ...
            <?php
                 ...
                 * ASKUPLOAD
                 */
                ask_comment_files($bo_table, $comment_id);
                }
            ?>
            ...
            <div id="edit_<?php echo $comment_id ?>"></div><!-- 수정 -->
            <div id="reply_<?php echo $comment_id ?>"></div><!-- 답변 -->
        ...
        <div class="bo_vc_w_wr">
            <div class="bo_vc_w_info">
                ...
                if (AU_COMMENT == true) {
                     ...
                     * ASKUPLOAD - 댓글 첨부파일
                     */
                    include_once G5_PLUGIN_PATH . DIRECTORY_SEPARATOR . "ask-uploader". DIRECTORY_SEPARATOR . "askupload.comment.php";
                }
                ?>
                <div class="finuploader-comment"></div>
    ...
    function comment_box(comment_id, work)
    {
        ...
        if (save_before != el_id)
        {
            ...
            if (work == 'cu')
            {
                ...
                <?php if (AU_COMMENT == true) {?>
                //ASKUPLOADER
                $('#ask-uploader-drop').unbind().empty();
                ask_upload('#'+el_id + ' .finuploader-comment',comment_id);
                <?php } ?>
            }
            <?php if (AU_COMMENT == true) {?>
            //ASKUPLOADER
            if (work == 'c' && comment_id){
                $('#ask-uploader-drop').unbind().empty();
                ask_upload('#'+el_id + ' .finuploader-comment',<?php echo$rand_wr_id?>);
            }
            <?php }?>
