...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <?php } ?>
            <th class="mobile-no-show" scope="col">번호</th>
            <th scope="col">제목</th>
            <th scope="col">글쓴이</th>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
            ...
            <?php } ?>
            <td class="td_num2 mobile-no-show">
            <?php
            ...
            <td class="td_num mobile-no-show"><?php echo $list[$i]['wr_hit'] ?></td>
            <?php if ($is_good) { ?><td class="td_num"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
            <?php if ($is_nogood) { ?><td class="td_num mobile-no-show"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
            <td class="td_datetime mobile-no-show"><?php echo $list[$i]['datetime2'] ?></td>
